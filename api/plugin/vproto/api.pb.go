...
func (m *AdjustContainersRequest) GetUpdates() []*ContainerUpdate {
	if m != nil {
		return m.Updates
	}
	return nil
...
func (m *AdjustContainersResponse) GetFailed() []*ContainerUpdate {
	if m != nil {
		return m.Failed
	}
	return nil
...
func (m *PingRequest) GetRequestNumber() uint32 {
	if m != nil {
...
func (m *PingResponse) GetRequestNumber() uint32 {
	if m != nil {
		return m.RequestNumber
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*AdjustContainersRequest)(nil), "vproto.AdjustContainersRequest")
...
func (m *PingRequest) Size() (n int) {
	...
	_ = l
	if m.RequestNumber != 0 {
		n += 1 + sovApi(uint64(m.RequestNumber))
	}
	l = len(m.Msg)
	if l > 0 {
		n += 1 + l + sovApi(uint64(l))
...
func RegisterRuntimeService(srv *github_com_containerd_ttrpc.Server, svc RuntimeService) {
	srv.Register("vproto.Runtime", map[string]github_com_containerd_ttrpc.Method{
...
func (c *runtimeClient) AdjustContainers(ctx context.Context, req *AdjustContainersRequest) (*AdjustContainersResponse, error) {
	...
	if err := c.client.Call(ctx, "vproto.Runtime", "AdjustContainers", req, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}

func (c *runtimeClient) Ping(ctx context.Context, req *PingRequest) (*PingResponse, error) {
	var resp PingResponse
	if err := c.client.Call(ctx, "vproto.Runtime", "Ping", req, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RequestNumber |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
